      ...
      <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-[40px] w-[640px] h-[640px] ]'>
        ...
        {isDoorUse && (
          <div className='absolute w-full h-full z-[10] bg-black opacity-80'>
            <div className='absolute bottom-0 flex justify-between gap-[6px] z-[20]'>
              <MapArea
