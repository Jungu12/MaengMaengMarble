...
//            return gameInfo;
    ...
    public void purchaseAndUpdateGameInfo(String roomCode, boolean[] purchasedBuildings) {
        ...
        // TODO : 바뀐 정보 REDIS 에 UPDATE 해 주는 로직 구현 예정

        // TODO : 바뀐 정보 return 해 주는 로직 구현 에정
    }
    ...
    public ResponseDto forSale(String roomCode, int landId) {
        ...
        // TODO : 바뀐 정보 return 해 주는 로직 구현 예정
     ...
     * @param roomCode
     */
    public void payFee(String roomCode) {
        // 게임 정보 가져오기
        GameInfo gameInfo = gameInfoRepository.getGameInfo(roomCode);
        Player[] players = gameInfo.getPlayers();
    ...
    public ResponseDto takeOver(String roomCode) {
        ...
        // 바뀐 정보 return
        // TODO: data에 실어서 전달할 객체 어떻게 할지 정하기
        return ResponseDto.builder().type("자유").data().build();
    }
